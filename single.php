...
<?php get_header(); ?>
    ...
    <main class="main-content">
      ...
      <article class="main-article wrapper">
        ...
        <footer class="main-article__footer">
          ...
          <!-- для GET в теге <а> " echo esc_url(admin_url('admin-post.php')); ?>?action=test_action" -->
          <button
	...
	C52.216,18.553,51.97,16.611,51.911,16.242z" />
          ...
          <!-- второгй саособ отправить на Ajax сссылку на скрипт admin-ajax.php -->
          <script>
          ...
          <script>
            window.addEventListener('load', function(){
              ...
              //let test = localStorage.getItem('liked');
              //console.log(test);
