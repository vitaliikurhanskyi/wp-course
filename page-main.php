...
<?php get_header(); ?>
    ...
    <main class="main-content">
      ...
      <?php 
        if (is_active_sidebar('si-main-article')) {
            dynamic_sidebar('si-main-article');
          } 
      ?>
      ...
      //var_dump(get_field('sales_actual', $sales[0]->ID));
      //var_dump(get_post_meta($sales[0]->ID, 'sales_actual', true ));
          ...
          ?>
            <section class="slider__slide stock">
              <a href="<?php the_permalink(); ?>" class="stock__link" aria-label="Подробнее об акции скидка 20% на групповые занятия">
                <!-- <img src=". '/assets/'; ?>img/index__sales_pic1.jpg" alt="" class="stock__thumb"> -->
          ...
          ?>     
            <li class="card <?php echo $profit_class; ?>" <?php echo $bg; ?>>
              ...
              <ul class="card__features">
                <?php foreach($benefits as $str) : ?>
                <li class="card__feature"><?php echo $str; ?></li>
                <?php endforeach; ?>
              </ul>
